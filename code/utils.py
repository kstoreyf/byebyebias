...
def get_color(pt):
    color_dict = {'tophat':'#1A85FF', 'standard': 'orange', 'piecewise':'crimson', 'linear_spline':'red', 'cosmo deriv':'purple', 'triangle':'crimson', 'quadratic_spline':'#D41159', 'quadratic_spline_nbins8':'limegreen', 'gaussian_kernel':'orangered'}
